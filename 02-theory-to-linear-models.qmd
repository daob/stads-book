 ...
 * An indirect effect is equal to the *product* of path coefficients along the indirect paths: $X \overset{a}{\rightarrow} Y_1 \overset{b}{\rightarrow} Y_2$ means the indirect effect equals $ab$

 * A spurious relationship is equal to the product of the two paths running from the common cause to each of the two variables: $X \begin{array}{c} \overset{a}{\nearrow} Y_1 \\ \underset{b}{\searrow} Y_2 \end{array}$ means the spurious effect is $ab$
